...
-- Author :       Jose
--
-- Date Created : Thursday, August 13, 2015 15:37:21
...
CREATE TABLE MaAEROPUERTO(
    ncodaeropuerto       DECIMAL(10, 0)    NOT NULL,
    vnombreaeropuerto    VARCHAR(20),
    ncodtipodestino      DECIMAL(10, 0),
    PRIMARY KEY (ncodaeropuerto)
)ENGINE=MYISAM
;
...
ALTER TABLE MaAEROPUERTO ADD CONSTRAINT RefTrDESTINO18 
...
ALTER TABLE MaVUELO ADD CONSTRAINT RefMaAEROPUERTO20 
    FOREIGN KEY (ncodaeropuerto)
    REFERENCES MaAEROPUERTO(ncodaeropuerto)
;
...
ALTER TABLE TrASIENTO ADD CONSTRAINT RefMaAVION21 
    FOREIGN KEY (ncodavion)
    REFERENCES MaAVION(ncodavion)
;
...
ALTER TABLE TrRESERVA ADD CONSTRAINT RefMaAVION23 
    FOREIGN KEY (ncodavion)
    REFERENCES MaAVION(ncodavion)
;
